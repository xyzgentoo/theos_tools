...
install_theos() {
    ...
    #curl -O http://dl.dropbox.com/u/3157793/ldid - this one seems to be a bad binary
    chmod a+x ldid
...
linkIOKit() {
	#without it, you may hit make errors
	echo "Going to link IOKit... Please enter your root password..."
